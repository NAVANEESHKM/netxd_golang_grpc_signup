...
type AuthServiceClient interface {
	SignUpUser(ctx context.Context, in *SingUpUserInput, opts ...grpc.CallOption) (*GenericResponse, error)
...
func (c *authServiceClient) SignUpUser(ctx context.Context, in *SingUpUserInput, opts ...grpc.CallOption) (*GenericResponse, error) {
...
type AuthServiceServer interface {
	SignUpUser(context.Context, *SingUpUserInput) (*GenericResponse, error)
	// rpc SignInUser(SignInUserInput) returns (SignInUserResponse){}
...
func (UnimplementedAuthServiceServer) SignUpUser(context.Context, *SingUpUserInput) (*GenericResponse, error) {
